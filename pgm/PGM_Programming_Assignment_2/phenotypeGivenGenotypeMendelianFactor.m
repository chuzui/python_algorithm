...
if isDominant == 1
    setOnesAssignments = assignments(xor((assignments(:,1)~=1), (assignments(:,2) == 1 | assignments(:,2) == 2)),:); 
else
    setOnesAssignments = assignments(xor((assignments(:,1)~=2), (assignments(:,2) == 1 | assignments(:,2) == 2)),:);
end
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, setOnesAssignments, 1);
