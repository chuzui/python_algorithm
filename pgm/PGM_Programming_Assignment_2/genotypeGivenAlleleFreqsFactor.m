...
genotypeFactor.card = len;

allelesVals = alleleFreqs * alleleFreqs';
vals = full(sparse(allelesToGenotypes,1,allelesVals));
assignments = IndexToAssignment(1:len, genotypeFactor.card);
genotypeFactor = SetValueOfAssignment(genotypeFactor, assignments, vals);
