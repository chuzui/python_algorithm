...
three_digits_set = {i for i in range(base ** 3)}

## Task 10
S = {1, 2, 3, 4}
T = {3, 4, 5, 6}
S_intersect_T = {i for i in S & T}

## Task 11
a = [20, 10, 15, 75]
L_average = sum(a) / len(a)
...
## Task 16
first_of_tuples_list = [(i, j, k)for i in S for j in S for k in S  if i + j + k == 0 ][0]
